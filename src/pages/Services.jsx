            ...
            <section className="container my-5 text-center">
                <div className="row">
                    <article className="col-lg-4 col-md-4 mb-4 d-flex flex-wrap">
                        <div className="services-bloc bg-white shadow p-4 rounded">
                            <img src={Ux} alt="ux-icon" className="services-icon"/>
                    ...
                    <article className="col-lg-4 col-md-4 mb-4 d-flex flex-wrap">
                        <div className="services-bloc bg-white shadow p-4 rounded">
                            <img src={WWW} alt="www-icon" className="services-icon"/>
                    ...
                    <article className="col-lg-4 col-md-4 mb-4 d-flex flex-wrap">
                        <div className="services-bloc bg-white shadow p-4 rounded">
                            <img src={Seo} alt="seo-icon" className="services-icon"/>
